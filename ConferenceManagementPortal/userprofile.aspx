<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="userprofile.aspx.cs" Inherits="ConferenceManagementPortal.WebForm7" %>
				...
				<div class="card">
					<div class="card-body">
						...
						<div class="row">
							<div class="col">
								<center>
									...
									<asp:Label class="badged badge-pill badge-info" ID="Label1" runat="server" Text="Your status"></asp:Label>
								</center>
							</div>
						</div>
						<div class="row">
						...
						<div class="row">
							<div class="col">
								<center>
									<span class="badged badge-pill badge-info">Login Credentials</span>
								</center>
							</div>
						</div>
						<div class="row">
